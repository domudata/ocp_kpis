...
def inject_custom_css():
    ...
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    .stTabs [data-baseweb="tab-list"]{gap:0!important;background:transparent!important;padding:0!important;border-bottom:2px solid #e2e8f0;margin-bottom:12px}
    .stTabs [data-baseweb="tab"]{border-radius:0!important;padding:10px 20px!important;font-weight:600!important;font-size:15px!important;line-height:1.4!important;min-height:42px!important;color:#64748b!important;background:transparent!important;border:none!important;border-bottom:3px solid transparent!important;margin-bottom:-2px;transition:color 0.2s, border-color 0.2s}
    .stTabs [data-baseweb="tab"]:hover{color:#1e3a5f!important;background:rgba(30,58,95,0.04)!important}
    .stTabs [aria-selected="true"]{background:transparent!important;color:#1e3a5f!important;font-weight:700!important;border-bottom:3px solid #ef4444!important;box-shadow:none!important}
    .stTabs [data-baseweb="tab"] span,.stTabs [data-baseweb="tab"] > div{font-size:15px !important}
    .stTabs [data-baseweb="tab"] svg{width:18px!important;height:18px!important}
    ...
    div[data-testid="stSidebar"] .stSelectbox label,div[data-testid="stSidebar"] .stMultiSelect label,div[data-testid="stSidebar"] .stDateInput label{color:rgba(255,255,255,.9)!important;font-weight:600;font-size:13px;text-transform:uppercase;letter-spacing:.5px}
    ...
    @media(max-width:768px){.cr{grid-template-columns:repeat(2,1fr)}.mh{padding:8px 10px;gap:8px}.mh h1{font-size:18px}.mh .logo{height:35px;max-width:70px}.mh .db{font-size:11px;padding:2px 8px}.tw{font-size:10px}.tw thead th,.tw tbody td{padding:3px 4px}.stl{font-size:13px}.stTabs [data-baseweb="tab"]{padding:8px 12px!important;font-size:13px!important}.stTabs [data-baseweb="tab"] span{font-size:13px!important}}
