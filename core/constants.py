...
QK = ["TAUX_REALISATION_CORRECTIF/PT","OT préparation <1 mois","OT préparation >3 mois",
      ...
      "OT exécution 1mois< <3mois","Performance Graissage","Performance Inspection","Performance Systématiques"]
PK = ["Taux d'approbation des Avis","OT LANC ESTIME","Backlog préparation caractérisé",
      "Backlog planification caractérisé","OT CONFIME","OT_COR_EGAL","OT Fiabilité","Total Avis de Panne"]
ALL_KPI = QK + PK
...
CIBLE = {"TAUX_REALISATION_CORRECTIF/PT":85,"OT préparation <1 mois":80,"OT préparation >3 mois":5,
         ...
         "Performance Systématiques":95,"OT Fiabilité":100,"Total Avis de Panne":100}
...
KPI_RESP_MAP = {
    ...
    "Performance Systématiques": "Chef d'atelier","OT Fiabilité": "Fiabilité","Total Avis de Panne": "Fiabilité"
}
