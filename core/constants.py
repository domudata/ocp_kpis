# -*- coding: utf-8 -*-
"""Toutes les constantes du dashboard : listes de KPI, cibles, mappings, consignes HSE."""
...
PK = [
    "Taux d'approbation des Avis", "OT LANC ESTIME", "Backlog préparation caractérisé",
