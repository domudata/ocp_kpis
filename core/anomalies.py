...
def build_ano_map(dfp: pd.DataFrame, avf: pd.DataFrame, now_ts,
    ...
    # ── OT préparation <1/1-3/>3 mois — DÉPEUPLEMENT EXACT DES OT NON CARACTÉRISÉS ──
    ...
    # ── OT planification <1/1-3/>3 mois — DÉPEUPLEMENT EXACT DES OT NON CARACTÉRISÉS ──
    ...
    # OT LANC ESTIME : statut LANC sur la période courante, sans condition ZCOR (demande explicite)
