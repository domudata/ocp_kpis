...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Inter', sans-serif; }
  ...
  th { background: #1e3a5f; color: #fff; font-weight: 700; padding: 6px 8px; border: 1px solid #1e3a5f; text-align: center; }
...
<body>
  ...
  <p class="subtitle">Date : {fichier_date} &nbsp;|&nbsp; Total : {total} &nbsp;|&nbsp; SF1 : {len(sf1_rows)} &nbsp;|&nbsp; SF2 : {len(sf2_rows)}</p>
  {body}
