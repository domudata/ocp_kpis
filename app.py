    ...
    try:
        ...
        with tabs[0]:
            render_dashboard_tab(
                vp, pscores, qscores, pa, qa, hist_df, now_ts, ano_map,
                ckdf=ckdf, sf1_p=sf1_p, sf1_q=sf1_q, sf2_p=sf2_p, sf2_q=sf2_q,
            )
        with tabs[1]:
            render_performance_qualite_tab(vp, ckdf, ano_map, anomaly_dfs, nd_full)
        with tabs[2]:
